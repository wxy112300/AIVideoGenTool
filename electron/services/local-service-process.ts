...
/**
 * Start app-owned ComfyUI Python with a visible Windows console.
 *
 ...
 * required diagnostics. The Python bootstrap binds these inherited streams to
 * the new console while unrelated helpers retain their hidden-process behavior.
 */
