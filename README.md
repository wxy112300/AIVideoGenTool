...
当前开发版本：**0.42.1**。本版本修复图生视频与视频续写切换期间旧状态覆盖独立 Slot 快照的问题，并在提示词增强成功后通过全局顶栏通知标明结果写回的创作页。版本变化见 [CHANGELOG.md](CHANGELOG.md)。项目仍在 `0.x` 阶段，优先支持 Windows、NVIDIA GPU 和本地 ComfyUI。
