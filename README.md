...
当前开发版本：**0.42.8**。本版本更新 Spectrum MiniMax H3 推荐版本至 `v0.2.17`，补充 H3 Continuum 互操作边界，并确认 Motion Context 续写仍需关闭 Spectrum。版本变化见 [CHANGELOG.md](CHANGELOG.md)。项目仍在 `0.x` 阶段，优先支持 Windows、NVIDIA GPU 和本地 ComfyUI。
