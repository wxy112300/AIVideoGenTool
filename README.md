...
当前开发版本：**0.41.9**。本版本让原生 SeedVR2 INT8 根据可用物理内存、显存和目标分辨率动态规划长视频切片，并在队列中分别展示总进度、当前切片、合并及临时文件清理状态。版本变化见 [CHANGELOG.md](CHANGELOG.md)。项目仍在 `0.x` 阶段，优先支持 Windows、NVIDIA GPU 和本地 ComfyUI。
