...
当前开发版本：**0.41.10**。本版本修复原生 SeedVR2 分段提升的合并成片在应用重启后被旧路径恢复逻辑覆盖的问题，并自动恢复已经受影响的历史版本。版本变化见 [CHANGELOG.md](CHANGELOG.md)。项目仍在 `0.x` 阶段，优先支持 Windows、NVIDIA GPU 和本地 ComfyUI。
