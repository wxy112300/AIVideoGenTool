...
当前开发版本：**0.43.0**。本版本更新 MiniMax H3 LoRA 目录：默认 FL2VA 4-step 切换至官方 LightX2V v1.1 768p，退役已知画质风险较高的旧 LoRA，并加入仅适用于 Ref2VA 的 AfterMidnight v1.2。版本变化见 [CHANGELOG.md](CHANGELOG.md)。项目仍在 `0.x` 阶段，优先支持 Windows、NVIDIA GPU 和本地 ComfyUI。
...
| H3 LoRA | LightX2V Turbo v1.1（768p 4-step）/ v1.0（8-step）、Ref2V Turbo、Realism People、AfterMidnight Ref2VA NSFW |
