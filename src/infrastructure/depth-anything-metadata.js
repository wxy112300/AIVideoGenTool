 ...
 */
export const DEPTH_ANYTHING_V2_SMALL_METADATA_RELATIVE_DIRECTORY = "assets/depth-anything-v2-small";
...
export function depthAnythingBuiltinMetadataFile(filename) {
    const value = filename === "config.json"
        ...
        : filename === "preprocessor_config.json"
            ...
            : undefined;
    if (!value)
        throw new Error(`未知的 Depth Anything 内置元数据文件：${filename}`);
