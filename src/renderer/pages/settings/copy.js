const zhCN = {
    ...
    "nodes.h3Badge": "ComfyUI v0.31.0+ · 推荐 v0.37.0",
...
const zhTW = {
    ...
    "nodes.h3Badge": "ComfyUI v0.31.0+ · 推薦 v0.37.0",
...
const enUS = {
    ...
    "nodes.h3Badge": "ComfyUI v0.31.0+ · recommended v0.37.0",
...
const h3AutoPromptSeedDescriptions = {
    "zh-CN": {
...
export function settingsH3AutoPromptSeedDescription(locale, seedId, fallback) {
    const activeLocale = locale ?? "zh-CN";
    return h3AutoPromptSeedDescriptions[activeLocale]?.[seedId] ?? fallback;
}

const modelHardwareRecommendations = {
    "zh-CN": {
...
export function settingsModelHardwareRecommendation(locale, profile) {
    const activeLocale = locale ?? "zh-CN";
...
function interpolate(text, params) {
    return text.replace(/\{([A-Za-z0-9_.-]+)\}/gu, (match, key) => {
        const value = params[key];
        return value == null ? match : String(value);
    });
}
export function settingsText(locale, key, params = {}) {
