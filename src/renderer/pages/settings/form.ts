...
export function readSettingsFromForm(
  ...
  return {
    ...
    h3SparseAttentionMode: value("h3-sparse-attention-mode", base.h3SparseAttentionMode) as Settings["h3SparseAttentionMode"],
    h3RuntimeMode: value("h3-runtime-mode", base.h3RuntimeMode) as Settings["h3RuntimeMode"],
    h3ComfyCompilerMode: value("h3-comfy-compiler-mode", base.h3ComfyCompilerMode) as Settings["h3ComfyCompilerMode"],
    h3VideoVaeMode: value("h3-video-vae-mode", base.h3VideoVaeMode) as Settings["h3VideoVaeMode"],
    ...
    vramStallWatchdogMinutes: Number(value("vram-stall-watchdog-minutes", String(base.vramStallWatchdogMinutes))) as Settings["vramStallWatchdogMinutes"],
