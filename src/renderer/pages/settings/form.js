...
export function readSettingsFromForm(base, h3PromptPreset, imagePromptPreset) {
    ...
    return {
        ...
        h3SparseAttentionMode: value("h3-sparse-attention-mode", base.h3SparseAttentionMode),
        h3RuntimeMode: value("h3-runtime-mode", base.h3RuntimeMode),
        h3ComfyCompilerMode: value("h3-comfy-compiler-mode", base.h3ComfyCompilerMode),
