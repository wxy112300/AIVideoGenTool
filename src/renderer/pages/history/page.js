...
export function renderImageHistoryPage(viewModel, options) {
    ...
    const timeline = renderHistoryTimeline(groupHistoryTimelineEntries(historyTimelineEntries(projects, viewModel.historyFilter.sort, options.uiLocale)), options, options.uiLocale);
...
export function renderHistoryPage(viewModel, options) {
    ...
    const timeline = renderHistoryTimeline(groupHistoryTimelineEntries(historyTimelineEntries(orderedAssets, viewModel.historyFilter.sort, options.uiLocale)), options, options.uiLocale);
...
export function renderHistoryDetailPage(viewModel, options) {
    ...
    const videoContinueAction = (variant, continuumAction = "Continue / Next") => {
