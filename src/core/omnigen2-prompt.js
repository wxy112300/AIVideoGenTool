...
export function omnigen2PromptContract(preset, presetText = "", outputMode = "plain") {
    ...
    return `${omnigen2ReferenceContract}\n${modeInstruction}\n${presetInstruction}${presetText.trim() ? `\nApply this user-configured preset rule as additional guidance:\n${presetText.trim()}` : ""}`;
}
export function omnigen2PromptUserContent(request) {
