...
const apiSchema: WorkflowSourceMetadata["schema"] = {
  id: "comfyui-api",
  version: 1,
  endpoint: "/prompt",
...
export const bundledWorkflowMetadata: Readonly<Record<string, WorkflowSourceMetadata>> = {
...
export function workflowMetadataForFilename(
  filename: string
