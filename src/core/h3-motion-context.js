...
export function isH3MotionContextHistoryFile(file) {
 ...
 */
export function h3MotionContextHistoryFileForPath(value, knownFiles = []) {
    ...
    const known = knownFiles.find((file) => isH3MotionContextHistoryFile(file) &&
