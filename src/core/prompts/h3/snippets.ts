...
export const h3SnippetDefinitions: readonly PromptSnippetDefinition[] = [
  ...
  { id: "camera-continuous-take", groupId: "camera-motion", text: "Single continuous take from the first frame to the last: use exactly one unbroken [Shot 1], with no cuts, edits, dissolves, wipes, montage, editorial transitions, shot resets, or teleportation. Preserve the same connected scene, subjects, spatial layout, and temporal continuity throughout. Any change of framing or viewpoint must come from continuous physical camera movement within this one shot—tracking, panning, tilting, orbiting, dollying, zooming, or focus pulling—not by switching to a new view." },
