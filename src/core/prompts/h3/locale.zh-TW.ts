...
export const uiLocale: PromptUiLocale = {
  ...
  snippetPicker: "快速插入",
  snippetPlaceholder: "選擇鏡頭、動作、聲音或對白片段",
  insertSnippet: "插入",
  ...
  helperTitle: "H3 提示詞助手",
  optional: "可選",
  helperModeSubtitle: "{mode} · 模板、檢查和構建器",
  modeR2v: "R2V 多參考",
  modeFl2va: "FL2VA 首尾影格",
  modeL2va: "L2VA 尾影格",
  modeT2va: "T2VA 純文字",
  modeI2va: "I2VA 首影格",
  toggleOpen: "開啟",
  toggleClose: "收起",
  referenceTagsTitle: "參考標籤",
  textTimelineTitle: "文字時間軸",
  referenceAlignmentTitle: "參考對齊",
  referenceR2vDescription: "按順序使用 Picture / Video 標籤，並給每個參考分配作用。",
  referenceT2vaDescription: "不新增圖片對齊句，直接從文字構建完整視聽時間軸。",
  referenceL2vaDescription: "從合理的前置狀態逐步收束到尾影格。",
  referenceDefaultDescription: "按官方格式先鎖定首影格或首尾影格，再寫連續動作。",
  timelineTitle: "時間軸",
  timelineDescription: "用 [Shot 1] 開始；後續鏡頭寫明確切時間。",
  soundTitle: "聲音與對白",
  soundDescription: "對白放入 d 標籤；現場聲和背景音樂分開描述。",
  helperIntro: "從模板開始，或開啟構建器逐項組合；都會新建版本，不覆蓋目前提示詞。",
  useTemplate: "使用結構模板",
  builderTitle: "結構化構建器",
  builderHint: "鏡頭、動作、連續性、聲音和螢幕文字",
  manualEditVersion: "手動編輯",
  expandedVersion: "擴寫 {count}",
  h3TemplateVersion: "H3 分鏡模板",
  h3BuilderVersion: "H3 構建器版本",
  templateCreated: "已建立 H3 {mode} 官方結構模板（{duration} 秒、{shots} 個鏡頭），原內容仍可透過左箭頭找回。",
  builderCreated: "已生成 H3 {mode} 結構化提示詞（{duration} 秒），原內容仍可透過左箭頭找回。",
