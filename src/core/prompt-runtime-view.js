 ...
 */
const activeOperationPhases = new Set([
    "preparing-service",
    "warming-model",
    "submitting",
    "queued",
...
const cancellableOperationPhases = new Set([
    "preparing-service",
    "warming-model",
    "submitting",
    "queued",
...
function activeOperation(operation, servicePhase) {
...
function transitionPromptButton() {
    return {
        icon: "sparkles",
        disabled: true,
        busy: true,
 ...
 */
export function projectPromptRuntimeView(snapshot, currentOrigin) {
