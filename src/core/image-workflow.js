...
export function imageOutputDimensions(sourceWidth, sourceHeight, targetResolution) {
    ...
    const shortEdge = Math.min(sourceWidth, sourceHeight);
    const normalizedTarget = normalizeImageTargetResolution(targetResolution, sourceWidth, sourceHeight);
...
export function imageResolutionOptionsFor(sourceWidth = 0, sourceHeight = 0) {
