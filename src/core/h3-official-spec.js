...
export function h3CommunityPromptWriterContract(mode, preset = "official-storyboard") {
    ...
    return [
        ...
        preset === "detailed-cinematic"
            ? "Detailed-expansion factual boundary: preserve every fact from the user's brief and supplied references. You may add reasonable, scene-grounded operational details that make the requested result executable, including ordinary micro-actions, anticipation, gaze or expression, body mechanics, contact, weight or momentum, and motivated camera behavior; add focus or light changes, ambience, or synchronized sound only when caused by the action or explicitly requested. Do not introduce new characters, locations, important props, plot events, visible text, dialogue, music, or major appearance changes, and never override an explicit constraint."
