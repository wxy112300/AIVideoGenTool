...
export const legacyVideoModelEntries: CatalogModelEntry[] = [
  ...
  }, { name: "Wan 2.2 I2V 5B", badge: "快速草稿", description: "适合 480p/540p 快速草稿和本机联调。" }, { name: "Wan 2.2 I2V 5B", badge: "Fast draft", description: "For fast 480p/540p drafts and local integration testing." }),
  entry({
  ...
  }, { name: "HunyuanVideo 1.5 I2V", badge: "质量", description: "质量优先，默认启用 VAE 分块和 CPU 卸载。" }, { name: "HunyuanVideo 1.5 I2V", badge: "Quality", description: "Quality-first profile with tiled VAE decoding and CPU offload enabled by default." }),
  entry({
  ...
  }, { name: "Wan 2.2 I2V 14B + NSFW", badge: "无审查", description: "需要高/低噪声模型及无审查文本编码器完整匹配。" }, { name: "Wan 2.2 I2V 14B + NSFW", badge: "Uncensored", description: "Requires matching high/low-noise models and the uncensored text encoder." }),
  entry({
  ...
  }, { name: "Wan 2.2 Remix v3", badge: "合并模型", description: "需要 Remix v3 High/Low 两阶段文件成对存在。" }, { name: "Wan 2.2 Remix v3", badge: "Blended model", description: "Requires matching Remix v3 High and Low two-stage files." }),
  entry({
  ...
  }, { name: "Wan 2.2 SmoothMix I2V", badge: "写实合并模型", description: "SmoothMix High/Low 两阶段模型，偏写实人物与自然运动。" }, { name: "Wan 2.2 SmoothMix I2V", badge: "Realistic blend", description: "High/Low SmoothMix stages tuned for realistic people and natural motion." }),
  entry({
  ...
  }, { name: "DaSiWa SynthSeduction v9", badge: "专用合并模型", description: "DaSiWa v9 High/Low 成对工作，偏写实人物与自然运动。" }, { name: "DaSiWa SynthSeduction v9", badge: "Dedicated blend", description: "DaSiWa v9 High/Low stages work as a pair for realistic people and natural motion." }),
  entry({
  ...
  }, { name: "HunyuanVideo 1.5 I2V + 1080p SR", badge: "双阶段 1080p", description: "先生成 720p latent，再使用官方 8 步 SR 分支输出 1080p。" }, { name: "HunyuanVideo 1.5 I2V + 1080p SR", badge: "Two-stage 1080p", description: "Generate a 720p latent first, then use the official eight-step SR branch for 1080p output." })
];
