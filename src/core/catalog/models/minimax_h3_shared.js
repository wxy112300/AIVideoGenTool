...
export const h3Int8ConvRotVideoVae = h3Component({
    ...
    alternativeGroup: "minimax-h3-video-vae",
    installGuide: guide(h3OfficialSource, `${h3Int8ConvRotVideoVaeBaseUrl}/vae/minimax_h3_video_vae_int8_convrot.safetensors`, "vae", "minimax_h3_video_vae_int8_convrot.safetensors", "官方 H3 INT8 ConvRot 视频 VAE 解码后端；需要 ComfyUI 0.31.0 或更高版本。未安装时工作流自动使用 FP16。")
});
