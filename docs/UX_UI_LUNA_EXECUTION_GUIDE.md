...
- G15 尚待人工/强模型批准当前 renderer 的 <=900 compact category 与 save/rescan 结构；在 G15 通过前不得派发 L52–L60。P17 实现必须继续以当前 renderer 为源，不得回放旧 prototype。
