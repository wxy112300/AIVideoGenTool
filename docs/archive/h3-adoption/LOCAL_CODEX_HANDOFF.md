...
状态：Archived historical handoff；当前任务不从本文件恢复。
...
本机环境、已知风险和下一步顺序。
 ...
 图片工作台的当前剩余事项见 [Image Workspace TASK](../../tasks/2026-09-07-image-workspace/TASK.md)；原始长计划保留在
 `docs/archive/image-workspace/IMAGE_WORKSPACE_IMPLEMENTATION_PLAN.md`。该模块的历史状态不能按
原型画面推断正式 Electron 功能已经实现。

> H3 V3 恢复任务的历史交接见 [`docs/archive/h3-adoption/2026.9.2-h3-comfyui-two-pass-av-upscale-recovery-v3-handoff.md`](2026.9.2-h3-comfyui-two-pass-av-upscale-recovery-v3-handoff.md)；当前下一步只从 [H3 高分辨率与 JointAV TASK](../../tasks/2026-09-07-h3-high-resolution/TASK.md) 进入。下方内容是较早的全局基线。
